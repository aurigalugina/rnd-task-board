...
export type ThemeName = 'retro-light' | 'retro-dark' | 'modern-light' | 'modern-dark' | 'aurora-glass' | 'ocean-breeze' | 'minimal-zen' | 'bold-vibrant';
...
export const THEMES: { key: ThemeName; label: string; titlebarA: string; face: string; winBlue: string }[] = [
  ...
  { key: 'minimal-zen',    label: 'Minimal Zen',       titlebarA: '#4F7B8F', face: '#FAFAFA', winBlue: '#4F7B8F' },
  { key: 'bold-vibrant',   label: 'Bold & Vibrant',    titlebarA: '#7C3AED', face: '#FFFFFF', winBlue: '#7C3AED' }
];
